...
public class Country {
    ...
    private Boolean doubleStatus = false;  // 过路费翻倍状态 -> 若一名玩家拥有所有的同样地块颜色的房屋，则过路费翻倍

    public int getTotalMortgagePrice() {
        return (houseNumber * buildHousePrice + hotelNumber * buildHotelPrice) / 2 + mortgagePrice;  // 每建一栋房子或者旅馆便能已一半的价格将他们抵押出去，再加上空地抵押费
    }
